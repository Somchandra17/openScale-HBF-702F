...
/**
 * Composable screen that displays the four fixed users.
 *
 * The scale has exactly four on-device user slots, so this screen only supports viewing and
 * editing (renaming, etc.) an existing user — there is deliberately no add or delete affordance
